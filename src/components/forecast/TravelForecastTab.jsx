...
/**
 * TravelForecastTab Component
 * Analyzes travel and relocation opportunities based on:
 * - Number 7 (Global Voyager)
 * - Number 4 (Karmic Relocator)
 * - 777/7777 pattern warnings
...
const TravelForecastTab = ({ report, dashaReport, targetDate }) => {
    ...
    const travelAnalysis = useMemo(() => {
        ...
        // 4 & 7 Combination Analysis
        if (has4InChart && has7InChart) {
            outlook.title = "This period is influenced by a combination of 4 & 7";
            if ([3, 5, 6].includes(annualDasha.dashaNumber)) { // Positive Dasha for this combo
        ...
        // Dasha-Driven Travel (no 4 or 7 in base chart)
        else {
